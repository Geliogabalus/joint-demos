...
class Data extends shapes.bpmn2.DataObject {
    ...
    defaults() {
        return util.defaultsDeep({
            ...
            markers: [],
            attrs: {
                label: Object.assign(Object.assign({}, defaultAttrs.shapeLabel), { refX: null, refY: null, refY2: null, x: 'calc(w/2)', y: `calc(h+${LABEL_Y_OFFSET})` }),
...
DataObject.label = DataLabels['data.DataObject'];
DataObject.icon = dataIconClasses.DATA_OBJECT;
...
DataInput.label = DataLabels['data.DataInput'];
DataInput.icon = dataIconClasses.DATA_INPUT;
...
DataOutput.label = DataLabels['data.DataOutput'];
DataOutput.icon = dataIconClasses.DATA_OUTPUT;
...
export class DataStore extends shapes.bpmn2.DataStore {
    ...
    defaults() {
        return util.defaultsDeep({
            ...
            attrs: {
                label: Object.assign(Object.assign({}, defaultAttrs.shapeLabel), { text: 'Data Store' }),
                labelBody: defaultAttrs.labelBody
            },
            size: {
                width: 50,
...
DataStore.label = DataLabels['data.DataStore'];
DataStore.icon = dataIconClasses.DATA_STORE;
