...
export class Annotation extends shapes.bpmn2.Annotation {
    ...
    defaults() {
        return util.defaultsDeep({
            ...
            attrs: {
                label: Object.assign(Object.assign({}, defaultAttrs.shapeLabel), { refDy: null, refY: null, refY2: null, refX: 6, y: 'calc(h / 2)', textAnchor: 'start', textVerticalAnchor: 'middle', text: 'Annotation' })
            }
        }, super.defaults);
    }
    ...
    validateConnection(targetModel) {
        if (getPoolParent(this) === targetModel)
            return false;
        const targetType = targetModel === null || targetModel === void 0 ? void 0 : targetModel.get('shapeType');
        return ![
