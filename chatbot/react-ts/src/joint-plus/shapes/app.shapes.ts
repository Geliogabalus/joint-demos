...
import { util, dia, g } from '@joint/plus';
import {
    MAX_PORT_COUNT,
    FONT_FAMILY,
    OUT_PORT_HEIGHT,
...
export class Base extends dia.Element {
    ...
    static type = ShapeTypesEnum.BASE;

    boundaryPadding?: Parameters<typeof util.normalizeSides>[0];

    defaults(): dia.Element.Attributes {
        return util.defaultsDeep({ type: ShapeTypesEnum.BASE }, super.defaults);
    }

    getBoundaryPadding() {
        return util.normalizeSides(this.boundaryPadding ?? 0);
    }
    ...
    static fromStencilShape(element: dia.Element): Base {
        ...
        return new (this as unknown as typeof Base)({ attrs });
    }
}
...
export class Message extends Base {
    ...
    static type = ShapeTypesEnum.MESSAGE;
...
export class FlowchartStart extends Base {

    static type = ShapeTypesEnum.FLOWCHART_START;
    ...
    defaults(): dia.Element.Attributes {
        return util.defaultsDeep({
            type: ShapeTypesEnum.FLOWCHART_START,
...
export class FlowchartEnd extends Base {

    static type = ShapeTypesEnum.FLOWCHART_END;
    ...
    defaults(): dia.Element.Attributes {
        return util.defaultsDeep({
            type: ShapeTypesEnum.FLOWCHART_END,
            size: { width: 48, height: 48 },
            ports: {
                groups: {
                    in: {
...
export class Link extends dia.Link {
    ...
    static type = ShapeTypesEnum.LINK;
