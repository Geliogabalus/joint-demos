...
import { util, dia } from '@joint/plus';
import {
    FONT_FAMILY,
    PADDING_L,
    LIGHT_COLOR,
...
export class FlowchartStart extends dia.Element {
...
export class FlowchartEnd extends dia.Element {
...
export class Message extends dia.Element {
