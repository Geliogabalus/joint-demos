import { Bot, FileCode2, FileText, Type, type LucideIcon } from "lucide-react";
import type { NodeIconName } from "@/workflow/workflow-types";

const ICONS: Record<Exclude<NodeIconName, "reddit">, LucideIcon> = {
  type: Type,
  "file-code": FileCode2,
  bot: Bot,
  "file-text": FileText,
...
interface NodeIconProps {
  readonly name: NodeIconName;
  readonly className?: string;
}

export function NodeIcon({ name, className }: NodeIconProps) {
  if (name === "reddit") return <RedditIcon className={className} />;
